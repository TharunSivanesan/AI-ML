...
move( state(A,B,C,D,E,F,0,H,J), state(A,B,C,0,E,F,D,H,J), up   ).

move( state(A,B,C,D,E,F,G,0,J), state(A,B,C,D,E,F,0,G,J), left ).
move( state(A,B,C,D,E,F,G,0,J), state(A,B,C,D,0,F,G,E,J), up   ).
move( state(A,B,C,D,E,F,G,0,J), state(A,B,C,D,E,F,G,J,0), right).
